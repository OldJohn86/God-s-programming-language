...
void show_highscore() {
    ...
    if(top_score > player.highscore)
        printf("%s has high score of %u\n", top_name, top_score);
    else
        printf("You cuurently have the high score of %u credits!\n", player.highscore);
    printf("\n===============================================================\n");
}
...
int take_wager(int available_credits, int previous_wager) {
    ...
    scanf("%d", &wager);
    if(wager < 1) {
        printf("Nice try, but you must wager a postitive number!\n");
        return -1;
    }
    return wager;
}
...
int pick_a_number() {
    ...
    printf("The winnnig number is %d\n", winning_number);
...
int find_the_ace() {
    ...
    printf("******* Find the Ace *******\n");
    printf("In this game, you can wager up to all of your credits.\n");
    printf("Three crads will be dealt out, two queens and one ace.\n");
    printf("If you find the ace, you will win your wager.\n");
    printf("After choosing a card, one of the queens will be revealed.\n");
    printf("At this point, you may either select a different crad or\n");
    ...
    if(pick == ace) {
        ...
        player.credits -= wager_one;
        if(wager_two != -1) {
            printf("and an additionla %d credits form your second wager!\n", wager_two);
            player.credits -= wager_two;
        }
    }
    return 0;
