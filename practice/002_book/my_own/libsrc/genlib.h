 ...
 * provide documentation that a variable will takes on only one of
 ...
 * important to take he string apart into its component characters.
 ...
 * General notes:
 * --------------
 * These functions provide a commom  interface for memory
 ...
 * -------------------------------------
 * GetBlock allocates a block of memory of given size. If
 ...
 * values of th specified element type.
 */
