 ...
 * number of digits that can appear in number.
 */
...
string CovertToUpperCase(string s)
{
    string result;
    int i;
 ...
 * -----------------------------
 * This function dynamically allocate space for a string of
